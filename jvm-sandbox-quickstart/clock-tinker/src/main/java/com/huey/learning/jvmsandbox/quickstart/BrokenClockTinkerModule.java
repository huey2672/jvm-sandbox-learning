...
public class BrokenClockTinkerModule implements Module {
    ...
    public void repairCheckState() {
        new EventWatchBuilder(moduleEventWatcher)
                .onClass("com.huey.learning.jvmsandbox.quickstart.Clock")
                .onBehavior("checkState")
                .onWatch(new AdviceListener() {
                    /**
                     * 拦截 {@code com.huey.learning.jvmsandbox.quickstart.Clock#checkState()} 方法，
                     * 当这个方法抛出异常时会被 AdviceListener#afterThrowing() 所拦截
                     */
                    @Override
